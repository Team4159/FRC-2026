...
public class Telemetry {
    ...
    private final StructPublisher<Pose2d> fieldPublisher = robotPoseNetworkTable
    ...
    private final MechanismLigament2d[] driveModuleDirections = new MechanismLigament2d[] {
        driveModuleMechanisms[0]
            .getRoot("RootDirection", 0.5, 0.5)
            .append(new MechanismLigament2d("Direction", 0.1, 0, 0, new Color8Bit(Color.kWhite))),
        driveModuleMechanisms[1]
            .getRoot("RootDirection", 0.5, 0.5)
            .append(new MechanismLigament2d("Direction", 0.1, 0, 0, new Color8Bit(Color.kWhite))),
        driveModuleMechanisms[2]
            .getRoot("RootDirection", 0.5, 0.5)
            .append(new MechanismLigament2d("Direction", 0.1, 0, 0, new Color8Bit(Color.kWhite))),
        driveModuleMechanisms[3]
            .getRoot("RootDirection", 0.5, 0.5)
            .append(new MechanismLigament2d("Direction", 0.1, 0, 0, new Color8Bit(Color.kWhite))),
    };
    ...
    public void telemeterize(SwerveDriveState state) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            driveModuleSpeeds[i].setLength(
                state.ModuleStates[i].speedMetersPerSecond / (2 * DrivetrainConstants.MAX_TRANSLATION_SPEED)
            );
        }
    }
}
