...
public class Telemetry {
    ...
    public void telemeterize(SwerveDriveState state) {
        ...
        fieldPub.set(new Pose2d(state.Pose.getX(), state.Pose.getY(), state.Pose.getRotation()));
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            m_moduleSpeeds[i].setLength(
                state.ModuleStates[i].speedMetersPerSecond / (2 * DrivetrainConstants.MAX_TRANSLATION_SPEED.baseUnitMagnitude())
            );
        }
    }
}
