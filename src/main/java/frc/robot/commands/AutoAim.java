...
public class AutoAim extends Command {
    ...
    public void execute() {
        ...
        double vx = Constants.ShooterConstants.launchVelocity * Math.cos(pitch);
        double vy = Constants.ShooterConstants.launchVelocity * Math.sin(pitch);
        trajectoryVisual.update(t -> new Translation2d(vx * t, vy * t - 0.5 * Constants.FieldConstants.g * t * t));
    }
