...
public class Drivetrain extends CommandSwerveDrivetrain {
    ...
    public class Drive extends Command {
        ...
        private SwerveRequest getTeleopDrive(boolean robotRelative) {
            ...
            if (getDriveFlagValue(DriveFlag.SLOW_MODE)) {
                maxTranslationSpeed *= kPrimarySlowModeTranslationFactor;
                maxRotationSpeed *= kPrimarySlowModeRotationFactor;
            ...
            } else if (getDriveFlagValue(DriveFlag.INTAKE_ASSIST) && getInputTranslation(true).getNorm() >= kPrimaryIntakeRotationInputDeadzone) {
                Angle angle;
