...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        primaryController.x().and(DriverStation::isTest).whileTrue(new AutoRecovery(drivetrain, intake, BeachRecoveryMode.ZIG_ZAG, BeachRecoverySide.LEFT, new AutoAim(drivetrain, shooter, hopper, intake, leds, false, Optional.empty())));
